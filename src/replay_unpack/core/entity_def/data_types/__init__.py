...
from .constants import INFINITY  # noqa
from .math import (
    Vector2,
    Vector3,
    Vector4,
...
from .other import Python, Blob, String, FixedDict, Array, Mailbox, UserType
...
class Alias:
    ...
    def _initialize(self, base_dir):
        ...
        with open(alias_path, "rb") as f:
            xml = etree.parse(f, parser=etree.XMLParser(encoding="utf8", remove_comments=True))
